...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("br.com.boagestao".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("BGDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://boagestao.com.br/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://boagestao.com.br";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "boagestao.com.br";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("bgdesk docs home", LINK_DOCS_HOME),
        ("bgdesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("bgdesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RS_PUB_KEY: &str = "hy3fp1caHX+7TRpdwMXNAlce0KMFRSmHFFAd5d0sYLI=";
